...
{
    public partial class CatalogoTipoUsuarios : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand command = new SqlCommand("ConsultarTipoUsuario", con);
        ...
        protected void bagregar_Click(object sender, EventArgs e)
        {
            ...
            conexion.Open();
            SqlCommand cmd = new SqlCommand("AddTipoUsuario", conexion);
        ...
        protected void bborrar_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conexion = new SqlConnection(s);
            conexion.Open();
            SqlCommand cmd = new SqlCommand("DelTipoUsers", conexion);
        ...
        protected void bactualizar_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conexion = new SqlConnection(s);
            conexion.Open();
            SqlCommand cmd = new SqlCommand("UpdTipoUsuarios", conexion);
            cmd.Parameters.Add("@Descripcion", SqlDbType.VarChar).Value = tdescripcion.Text;
            cmd.Parameters.Add("@Codigo", SqlDbType.Int).Value = tcodigo.Text;
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.ExecuteNonQuery();
